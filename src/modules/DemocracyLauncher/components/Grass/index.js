...
export default function Index({ options = { bW: 0.12, bH: 1, joints: 5 }, width = 100, instances = 50000, ...props }) {
...
function multiplyQuaternions(q1, q2) {
  ...
  return new THREE.Vector4(x, y, 0, w)
}

function getYPosition(x, z) {
  var y = 2 * simplex.noise2D(x / 50, z / 50)
  y += 4 * simplex.noise2D(x / 500, z / 500)
  y += 0.02 * simplex.noise2D(x / 500, z / 500)
  return y
}
